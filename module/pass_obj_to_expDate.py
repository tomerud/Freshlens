...
if __name__ == "__main__":
    def find_exp_date(detections:List[Tuple[int, str,Any]]) ->List[Tuple[int, str,str]]:  
    # the function is responsible to manage to what function the image is passed on for analysis
    # Returns: List of the objects, (object_id,object_class,exp_date)
    ...
    #make it less "readable" and constarint the way we add new classes for detections
        ...
        full_exp=("banana","tomatoes")
        fruits_and_vegetables= ("apple",)#"fill other as fitting the dataset of trainnig detections"
